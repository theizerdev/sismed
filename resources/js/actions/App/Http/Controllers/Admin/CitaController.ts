...
export const sendResultadosWhatsApp = (args: { cita: number | { id: number } } | [cita: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: sendResultadosWhatsApp.url(args, options),
    method: 'post',
})

sendResultadosWhatsApp.definition = {
    methods: ["post"],
...
sendResultadosWhatsApp.url = (args: { cita: number | { id: number } } | [cita: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    ...
    return sendResultadosWhatsApp.definition.url
            .replace('{cita}', parsedArgs.cita.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 */
    const sendResultadosWhatsAppForm = (args: { cita: number | { id: number } } | [cita: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: sendResultadosWhatsApp.url(args, options),
        method: 'post',
    })
 ...
 */
    ...
    sendResultadosWhatsApp.form = sendResultadosWhatsAppForm
const CitaController = { index, getSlots, store, update, move, updateEstado, updatePago, destroy, sendWhatsAppRecordatorio, uploadResultado, deleteResultado, updateEstadoServicio, sendResultadosWhatsApp }
